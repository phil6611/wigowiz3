...
<html  lang="<?=$_SESSION['langue']; ?>"> 
    <head>
        ...
        <link rel="image_src"  href="http://www.wigowiz.com/image/logo_wigowiz.jpg"  />
        ...
        <link rel="stylesheet" type="text/css" href="./javascript/DataTables-1.10.4/media/css/jquery.dataTables.css">
